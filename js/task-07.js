...
//     произвольную строку, которая записывается
// на создаваемый объект в свойство value.
...
// этот метод.
//     padBoth(str) - получает парметр str(строку) и добавляет её в
// начало и в конец значения свойства value объекта, который вызывает
// этот метод.

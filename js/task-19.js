...
// значение параметра email в массив хранящийся в
// свойстве blacklistedEmails.
// Публичный метод isBlacklisted(email) для проверки
// почты в чёрном списке.Метод должен проверять
// наличие значения параметра email в массиве
// хранящемся в свойстве blacklistedEmails и
...
class Admin extends User {
    ...
    // blacklist(email) {
    //     email.push(this.blacklistedEmails);
    // }

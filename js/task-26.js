...
const eachElementInFirstIsOdd = firstArray.every(firstArr => firstArr % 2 !== 0);

const eachElementInSecondIsEven = secondArray.every(secondArr => secondArr % 2 === 0);
const eachElementInSecondIsOdd = secondArray.every(secondArr => secondArr % 2 !== 0);

const eachElementInThirdIsEven = thirdArray.every(thirdArr => thirdArr % 2 === 0);
const eachElementInThirdIsOdd = thirdArray.every(thirdArr => thirdArr % 2 !== 0);